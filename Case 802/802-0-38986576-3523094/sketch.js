...
Officer: 3523094
CaseNum: 802-0-38986576-3523094
...
function cardPicker() {
	for (var i = 0; i < playing_cards.length; i++) {
		if (playing_cards[i].cardSuit == "Hearts" || playing_cards[i].value == "8") {
