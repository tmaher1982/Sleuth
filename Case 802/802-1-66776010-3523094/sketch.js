...
Officer: 3523094
CaseNum: 802-1-66776010-3523094
...
* Using a for loop fill the array with 52 random integers between 1 and 72.
...
function fillShuffleArray() {
	...
	for (i = 0; i < 52; i++) {
		...
		shuffleArray.push(round(random(0, 73)));
